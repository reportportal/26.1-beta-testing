...
- “Build a portfolio dashboard across all my ReportPortal projects”
- “Give me a go / no-go for the release from Manual, Automated, and Agentic”
- “Org portfolio roll-up with risks and next actions”
...
3. Write `portfolio-dashboard.canvas.tsx` with visual widgets.
...
Top blockers:
- … (automated / manual / milestone)

Open the dashboard beside the chat: [portfolio-dashboard](…/canvases/portfolio-dashboard.canvas.tsx)
```
